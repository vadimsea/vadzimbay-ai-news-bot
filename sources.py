...
RSS_SOURCES: list[NewsSource] = [
    ...
    NewsSource("ScienceDaily Robotics", "https://www.sciencedaily.com/rss/computers_math/robotics.xml", "en", "robotics", 0.84),
    NewsSource("MarkTechPost", "https://www.marktechpost.com/feed/", "en", "ai", 0.72),
