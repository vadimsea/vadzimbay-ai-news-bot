...
RSS_SOURCES: list[NewsSource] = [
    ...
    NewsSource("TensorFeed", "https://tensorfeed.ai/feed.xml", "en", "ai", 0.78),
    NewsSource("Planet AI", "https://www.planet-ai.net/rss.xml", "en", "ai", 0.76),
    NewsSource("OnAI", "https://onai2.com/rss.xml", "en", "ai", 0.76),
    NewsSource("InfoQ AI", "https://feed.infoq.com/artificial_intelligence/news", "en", "ai", 0.82),
    ...
    NewsSource("UX Collective", "https://uxdesign.cc/feed", "en", "web_design", 0.58),
