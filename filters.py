...
TECH_KEYWORDS = {
    ...
    "next.js", "vue", "svelte", "css", "html", "accessibility", "performance",
    ...
    "ai developer", "ai programming", "prompt-to-code", "agentic coding",
    "cursor", "windsurf", "lovable", "bolt.new", "replit agent", "claude code",
    ...
    "фронтенд", "frontend", "front-end", "веб-разработка", "javascript", "typescript",
    "react", "next.js", "vue", "svelte", "css", "html", "доступность", "производительность сайта",
...
NEWS_EVENT_KEYWORDS = {
    ...
    "trend", "trends", "campaign", "tool", "platform", "coding assistant",
    "code assistant", "developer tool", "builder", "website builder", "ai agent",
    "video agent", "redesign", "case study", "conversion",
    "analytics", "growth", "frontend framework",
    ...
    "ассистент для кода", "инструмент для разработчиков", "редизайн", "кейс",
    "конверсия", "аналитика", "рост",
