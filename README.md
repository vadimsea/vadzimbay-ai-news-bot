...
Он проверяет промо каждый день в `12:00` и `15:00` по Минску. Расписание кампаний задаётся в `promo.py`: **ATEN** во вторник и пятницу, канал удалённой работы в среду, квартиры в Минске в воскресенье, бот-помощник программиста раз в 2 дня.
