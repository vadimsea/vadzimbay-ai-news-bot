...
TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ...
    (
        "#Frontend",
        (
            "frontend", "front-end", "web development", "javascript", "typescript",
    ...
    (
        "#Вайбкодинг",
        (
            "vibe coding", "vibecoding", "вайбкодинг", "вайб-кодинг", "ai coding",
            "coding agent", "cursor", "windsurf", "claude code", "lovable", "bolt.new",
        ),
    ),
